...
The sources for hreports can be downloaded from the `Github repo`_.
...
.. _Github repo: https://github.com/msmart/hreports
.. _tarball: https://github.com/msmart/hreports/tarball/master
